    ...
    return (
        <main className="min-h-screen bg-white font-mono selection:bg-charcoal selection:text-white">
            ...
            <motion.section 
                ...
                className="pt-32 md:pt-48 pb-16 md:pb-24 px-6 md:px-8 max-w-5xl mx-auto"
            >
                <div className="space-y-12 md:space-y-16">
                    ...
                    <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
            ...
            <section className="py-16 md:py-24 bg-charcoal/5 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    ...
                    >
                        {/* Card 1 */}
                        <motion.div variants={cardVariants} className="bg-white p-2 group cursor-crosshair">
                            ...
                            <div className="px-4 pb-6 space-y-2">
                                <h3 className="text-sm font-bold lowercase tracking-tight group-hover:translate-x-1 transition-transform duration-500">Renaissance (Desain Pertama)</h3>
                        ...
                        >
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <Link href="/collection" className="inline-block mt-4 border-b border-white/20 pb-1 text-[10px] uppercase tracking-widest text-white hover:border-white transition-colors duration-500 hover:tracking-[0.2em]">
                                    lihat katalog
                                </Link>
                            </div>
                        </motion.div>
