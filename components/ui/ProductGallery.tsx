                ...
                <div className="flex gap-4 overflow-x-auto pb-4 hide-scrollbar snap-x px-1">
                    {images.map((img, i) => (
                        <div
                            ...
                            className={`relative w-16 md:w-20 aspect-4/5 bg-beige shrink-0 cursor-pointer border-2 transition-all snap-start rounded-lg md:rounded-none overflow-hidden ${activeIndex === i ? 'border-charcoal' : 'border-transparent opacity-60 hover:opacity-100'}`}
                        >
